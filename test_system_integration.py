...
<parameter name="todos">[{"content": "Limpar sistema atual", "status": "completed", "activeForm": "Limpando sistema atual"}, {"content": "Reconstruir containers Docker", "status": "completed", "activeForm": "Reconstruindo containers Docker"}, {"content": "Inicializar sistema com make up", "status": "completed", "activeForm": "Inicializando sistema com make up"}, {"content": "Executar testes completos", "status": "completed", "activeForm": "Executando testes completos"}]