...
* [[ΨQRH Framework]]"""
    ...
    def _generate_direct_answer(self, input_text, prompt_info):
        """Gerar resposta direta e útil usando análise dinâmica"""

        # Usar Response Spectrum Analyzer para respostas dinâmicas
        from response_spectrum_analyzer import DynamicResponseGenerator

        generator = DynamicResponseGenerator()

        # Gerar resposta baseada na análise da pergunta
        response = generator.generate_response(input_text, prompt_info)
