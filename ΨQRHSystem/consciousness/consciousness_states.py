...
class StateClassifier:
    ...
    def _initialize_consciousness_states(self) -> Dict[str, ConsciousnessState]:
        """Inicializa estados de consciência baseados na configuração."""
        ...
        try:
            ...
            states = {
                'MEDITATION': ConsciousnessState(
                    ...
                    fractal_dimension=state_thresholds.get('meditation', {}).get('fractal_dimension_min', 2.4),
                    diffusion_coefficient=6.0,
                    consciousness_frequency=1.0,
                    fci_range=(state_thresholds.get('meditation', {}).get('min_fci', 0.7),
                              state_thresholds.get('emergence', {}).get('min_fci', 0.85)),
                ...
                'ANALYSIS': ConsciousnessState(
                    ...
                    fractal_dimension=state_thresholds.get('analysis', {}).get('fractal_dimension_min', 1.9),
                    diffusion_coefficient=3.0,
                    consciousness_frequency=2.0,
                    fci_range=(state_thresholds.get('analysis', {}).get('min_fci', 0.45),
                              state_thresholds.get('meditation', {}).get('min_fci', 0.7)),
                ...
                'COMA': ConsciousnessState(
                    ...
                    fci_range=(0.0, state_thresholds.get('analysis', {}).get('min_fci', 0.45)),
                ...
                'EMERGENCE': ConsciousnessState(
                    ...
                    fractal_dimension=state_thresholds.get('emergence', {}).get('fractal_dimension_min', 2.7),
                    diffusion_coefficient=9.0,
                    consciousness_frequency=4.0,
                    fci_range=(state_thresholds.get('emergence', {}).get('min_fci', 0.85), 1.0),
